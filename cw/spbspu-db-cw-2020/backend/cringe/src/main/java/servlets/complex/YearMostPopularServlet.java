...
@WebServlet(
    name = "YearMostPopularServlet",
    urlPatterns = "/year/most/popular")
public class YearMostPopularServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
    JSONObject jsonObject = complexService.getYearMostPopularTour();
