...
@WebServlet(
    name = "TourParticipantsByDateServlet",
    urlPatterns = "/tour/participants/by/tour/date")
public class TourParticipantsByDateServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    JSONObject jsonObject = complexService.getTourParticipantsByTourDate(reqJson);
