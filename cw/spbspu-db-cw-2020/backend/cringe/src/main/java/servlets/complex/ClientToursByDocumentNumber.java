...
@WebServlet(
    name = "ClientToursByDocumentNumberServlet",
    urlPatterns = "/client/tours/by/document/number")
public class ClientToursByDocumentNumber extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    JSONObject jsonObject = complexService.getClientToursByDocumentNumber(reqJson);
