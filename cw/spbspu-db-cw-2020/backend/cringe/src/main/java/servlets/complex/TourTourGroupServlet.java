...
@WebServlet(
    name = "TourTourGroupServlet",
    urlPatterns = "/tour/tour/group")
public class TourTourGroupServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    JSONObject jsonObject = complexService.getTourTourGroups(reqJson);
