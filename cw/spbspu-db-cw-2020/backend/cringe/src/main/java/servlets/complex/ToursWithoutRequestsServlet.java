...
@WebServlet(
    name = "ToursWithoutRequestsServlet",
    urlPatterns = "/tours/without/requests")
public class ToursWithoutRequestsServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
    JSONObject jsonObject = complexService.getToursWithoutAnyRequests();
