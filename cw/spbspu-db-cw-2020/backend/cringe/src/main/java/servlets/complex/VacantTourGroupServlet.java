...
@WebServlet(
    name = "VacantTourGroupServlet",
    urlPatterns = "/vacant/tour/group")
public class VacantTourGroupServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    JSONObject jsonObject = complexService.getVacantTourGroupsQuery();
