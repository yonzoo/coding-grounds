...
@WebServlet(
    name = "ToursWithRequestsServlet",
    urlPatterns = "/tours/with/requests")
public class ToursWithRequestsServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
    JSONObject jsonObject = complexService.getToursWithApprovedRequests();
